declare module "beson" {
	...
	type BinartIntLike<T> = T|BinaryIntBase|number|string;
	class BinaryIntBase {
		_ab: ArrayBuffer;
		_ba: Uint8Array;
		_ta: TypedArray;
	...
	class BinaryInt<T> extends BinaryIntBase {
		...
		compare(value:BinartIntLike<T>):number;
		isZero():boolean;
		toBytes():Uint8Array;
	...
	class UInt256 extends BinaryInt<UInt256> {
